                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="{{route('category')}}">
                                <i class="fas fa-table"></i>Danh mục phim</a>
                        </li>
                        <li>
                            <a href="{{route('country')}}">
                                <i class="far fa-check-square"></i>Quốc gia</a>
                        </li>
                        <li>
                            <a href="{{route('movie')}}">
                                <i class="fas fa-calendar-alt"></i>Phim</a>
                        </li>
                        <li>
                            <a href="{{route('episode')}}">
                                <i class="fas fa-map-marker-alt"></i>Tập phim</a>
                        </li>
                    </ul>
                </div>
            </nav>
                            ...
                            <div class="header-button">
                                        ...
                                        <div class="mess-dropdown js-dropdown">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('public/admin/images/icon/avatar-01.jpg')}}" alt="Michelle Moreno" />
                                                </div>
                                                <div class="content">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="{{ asset('public/admin/images/avatar-1.jpg')}}" alt="John Doe" />
                                        </div>
                                        <div class="content">
