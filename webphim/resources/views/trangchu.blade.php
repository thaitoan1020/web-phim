...
<html lang="vi">
   <head>
      ...
      <link rel='stylesheet' id='bootstrap-css' href='{{asset('public/css/bootstrap.min.css?ver=5.7.2')}}' media='all' />
      <link rel='stylesheet' id='style-css' href='{{asset('public/css/style.css?ver=5.7.2')}}' media='all' />
      <link rel='stylesheet' id='wp-block-library-css' href='{{asset('public/css/style.min.css?ver=5.7.2')}}' media='all' />
      <script type='text/javascript' src='{{asset('public/js/jquery.min.js?ver=5.7.2')}}' id='halim-jquery-js'></script>
                  ...
                  <div class="menu-menu_1-container">
                     <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                        ...
                        @foreach ($category as $item => $cate)
                           <li class="mega"><a title="{{ $cate->title }}" href="{{route('categoryxp',$cate->title_slug)}}">{{ $cate->title }}</a></li>
                        @endforeach
                        <li class="mega dropdown">
                           <a title="Thể Loại" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Thể Loại <span class="caret"></span></a>
                           <ul role="menu" class=" dropdown-menu">
                              @foreach ($genre as $item => $gen)
                                 <li><a title="{{ $gen->title }}" href="{{route('genrexp',$gen->title_slug)}}">{{ $gen->title }}</a></li>
                              @endforeach
                           </ul>
                        </li>
                        <li class="mega dropdown">
                           ...
                           <ul role="menu" class=" dropdown-menu">
                              @foreach ($country as $item => $count)
                                 <li><a title="{{ $count->title }}" href="{{route('countryxp',$count->title_slug)}}">{{ $count->title }}</a></li>
                              @endforeach
                           </ul>
                        </li>
                     </ul>
